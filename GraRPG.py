...
def wybierz_artefakt():
    print("\nWybierz artefakt:")
    print("1 - Magiczna kopia (dodaje bonus do siły)")
    print("2 - Ulepszony koń (dodaje bonus do inicjatywy)")
    print("3 - Magiczny naszyjnik (dodaje bonus do many)")
...
def losowe_wydarzenie():
    ...
    if wydarzenie == 'doping':
        ...
        if randint(1, 2) == 1:
            print("Wiedźma przepowiada, że rycerzowi {} uda się zwyciężyć!".format(gracz_1['name']))
        else:
            print("Wiedźma przepowiada, że rycerzowi {} uda się zwyciężyć!".format(gracz_2['name']))
...
def wykonaj_ture(gracz, przeciwnik_hp):
    ...
    print("3 - Leczenie (kosztuje 30 many)")
    print("4 - Zwiększenie inicjatywy (kosztuje 30 many)")
    print("5 - Zwiększenie siły (kosztuje 50 many)")
...
while gracz_1['hp'] > 0 and gracz_2['hp'] > 0:
    print("-" * 40)
    print(f"{gracz_1['name']} HP: {gracz_1['hp']} | Mana: {gracz_1['mana']} | Inicjatywa: {gracz_1['inicjatywa']} | {gracz_2['name']} HP: {gracz_2['hp']} | Mana: {gracz_2['mana']} | Inicjatywa: {gracz_2['inicjatywa']}")
    print("-" * 40)
